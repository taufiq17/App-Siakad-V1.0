...
public class AutoFitTableColumns implements PropertyChangeListener, TableModelListener{
     ...
     */
    public AutoFitTableColumns(JTable table){
        this(table, 6);
    }
     ...
     */
    public AutoFitTableColumns(JTable table, int spacing){
        this.table = table;
